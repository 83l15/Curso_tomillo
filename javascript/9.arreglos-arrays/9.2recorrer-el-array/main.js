const amigosInstagram=["Lucia","Juan","Pepe"];
console.log(amigosInstagram);
document.querySelector('button').innerHTML=`${amigosInstagram}`

console.log(amigosInstagram[0])
console.log(amigosInstagram[1])
console.log(amigosInstagram[2])
